...
# 14 "./external_eeprom.h" 2
# 65 "./external_eeprom.h"
...
void set_time(void)
{
    ...
    hh=(((clock_reg[0] >> 4) * 10) + (clock_reg[0] & 0x0F));
    mm=(((clock_reg[1] >> 4) * 10) + (clock_reg[1] & 0x0F));
    ss=(((clock_reg[2] >> 4) * 10) + (clock_reg[2] & 0x0F));

    clcd_write(0x01, 0);
    clcd_print("HH:MM:SS", (0x80 + 4));
    ...
    while(1)
    {
        ...
        {
            write_ds1307(0x02, (((hh / 10) << 4) | (hh % 10)));
            write_ds1307(0x01, (((mm / 10) << 4) | (mm % 10)));
            write_ds1307(0x00, (((ss / 10) << 4) | (ss % 10)));
            clcd_print("saving.....", (0x80 + 0));
        ...
        {
            clcd_putch((hh / 10) + '0', (0xC0 + 4));
            clcd_putch((hh % 10) + '0', (0xC0 + 5));
        }
        ...
        {
            clcd_putch((mm / 10) + '0', (0xC0 + 7));
            clcd_putch((mm % 10) + '0', (0xC0 + 8));
        }
        ...
        {
            clcd_putch((ss / 10) + '0', (0xC0 + 10));
            clcd_putch((ss % 10) + '0', (0xC0 + 11));
        }
